...
1. 注册账号，登录管理控制台。
    ...
    ![](../../res46.60/qiniu-manage-console.png)

2. 选择左侧菜单中的对象存储。

    ![](../../res46.60/qiniu-storage-service.png)
...
![](../../res46.60/qiniu-file-management.png)
