...
![](../../res46.60/http-request.png)

HTTP响应（响应行+响应头+空行+消息体）：

![](../../res46.60/http-response.png)
...
4. 用PyCharm打开创建好的Djang项目，并为其添加虚拟环境。
   ...
   ![](../../res46.60/pycharm-django-project.png)
   ...
   ![pycharm-django-virtual-environment](../../res46.60/pycharm-django-virtual-environment.png)
...
5. 安装项目依赖项。
   ...
   ![](../../res46.60/pycharm-install-django.png)
...
1. 在项目目录下创建名为templates文件夹。
   ...
   ![](../../res46.60/pycharm-django-template.png)
