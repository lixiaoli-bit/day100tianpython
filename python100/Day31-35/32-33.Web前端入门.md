...
> **说明**：本文使用的部分插图来自 *Jon Duckett* �?[HTML and CSS: Design and Build Websites](https://www.amazon.cn/dp/1118008189/ref=sr_1_5?__mk_zh_CN=%E4%BA%9A%E9%A9%AC%E9%80%8A%E7%BD%91%E7%AB%99&keywords=html+%26+css&qid=1554609325&s=gateway&sr=8-5)*一书，这是一本非常棒的前端入门书，有兴趣的读者可以在亚马逊或者其他网站上找到该书的购买链接�?

HTML 是用来描述网页的一种语言，全称是 Hyper-Text Markup Language，即超文本标记语言。我们浏览网页时看到的文字、按钮、图片、视频等元素，它们都是通过 HTML 书写并通过浏览器来呈现的�?

### HTML简�?

1. 1991�?0月：一个非正式CERN（[欧洲核子研究中心](https://zh.wikipedia.org/wiki/%E6%AD%90%E6%B4%B2%E6%A0%B8%E5%AD%90%E7%A0%94%E7%A9%B6%E7%B5%84%E7%B9%94)）文件首次公开18个HTML标签，这个文件的作者是物理学家[蒂姆·伯纳�?李](https://zh.wikipedia.org/wiki/%E8%92%82%E5%A7%86%C2%B7%E4%BC%AF%E7%BA%B3%E6%96%AF-%E6%9D%8E)，因此他是[万维网](https://zh.wikipedia.org/wiki/%E4%B8%87%E7%BB%B4%E7%BD%91)的发明者，也是[万维网联盟](https://zh.wikipedia.org/wiki/%E4%B8%87%E7%BB%B4%E7%BD%91%E8%81%94%E7%9B%9F)的主席�?
2. 1995�?1月：HTML 2.0标准发布（RFC 1866）�?
3. 1997�?月：HTML 3.2作为[W3C](https://zh.wikipedia.org/wiki/W3C)推荐标准发布�?
4. 1997�?2月：HTML 4.0作为W3C推荐标准发布�?
5.  1999�?2月：HTML4.01作为W3C推荐标准发布�?
6. 2008�?月：HTML5由W3C作为工作草案发布�?
7. 2011�?月：W3C将HTML5推进至“最终征求”（Last Call）阶段�?
8. 2012�?2月：W3C指定HTML5作为“候选推荐”阶段�?
9. 2014�?0月：HTML5作为稳定W3C推荐标准发布，这意味着HTML5的标准化已经完成�?
...
- 语义化标�?- figure / figcaption

#### 表格（table�?

- 基本的表格结�?- table / tr / td / th
- 表格的标�?- caption
- 跨行和跨�?- rowspan属�?/ colspan属�?
- 长表�?- thead / tbody / tfoot

#### 表单（form�?

- 重要属�?- action / method / enctype
- 表单控件（input�? type属�?
  - 文本�?- `text` / 密码�?- `password` / 数字�?- `number`
  - 邮箱 - `email` / 电话 - `tel` / 日期 - `date` / 滑条 - `range` / URL - `url` / 搜索 - `search`
  - 单选按�?- `radio` / 复选按�?- `checkbox`
  - 文件上传 - `file` / 隐藏�?- `hidden`
...
- 视频托管服务
- 添加视频的准备工�?
- video标签和属�?- autoplay / controls / loop / muted / preload / src
- audio标签和属�?- autoplay / controls / loop / muted / preload / src / width / height / poster
...
- 文本的大小和字型(font-size / font-family)
  ...
  ![](./res/衬线字体+非衬线字�?等宽字体.png)

- 粗细、样式、拉伸和装饰(font-weight / font-style / font-stretch / text-decoration)

  ![](./res/字体样式.png)

- 行间�?line-height)、字母间�?letter-spacing)和单词间�?word-spacing)

- 对齐(text-align)方式和缩�?text-ident)
...
- 客户端存�?- `localStorage`和`sessionStorage`
...
- 从服务器获取数据 - Fetch API
- 绘制图形 - `<canvas>`的API
- 音视�?- `<audio>`和`<video>`的API

### 前端框架

#### 渐进式框�?- [Vue.js](<https://cn.vuejs.org/>)
                        ...
                        data: {
                                tableData:  [
                                        ...
                                        }, 
                                        {
                                                date: '2016-05-04',
                                                name: '刘二�?,
                                                address: '上海市普陀区金沙江�?1517 �?
                                        }, 
                                        {
                                                date: '2016-05-01',
                                                name: '杨三�?,
                                                address: '上海市普陀区金沙江�?1519 �?
                                        }, 
                                        {
                                                date: '2016-05-03',
                                                name: '陈四�?,
                                                address: '上海市普陀区金沙江�?1516 �?
                                        }
                                ]
                        }
                })
