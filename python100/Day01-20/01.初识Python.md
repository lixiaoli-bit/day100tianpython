###  初识Python📂 [精简版点这里](../../jianjieban/1.20/01.html)
...
接下来，安装向导会提示你勾选需要的“Optional Featu../../res1.20”（可选特性），这里咱们可以直接全选。值得一提的是其中的第2项，它是 Python 的包管理工具 pip，可以帮助我们安装三方库和三方工具，所以一定要记得勾选它，然后点击“Next”进入下一环节。
