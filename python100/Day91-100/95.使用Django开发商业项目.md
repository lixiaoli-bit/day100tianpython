...
![](../../res91.100/django_request_response_cycle.png)
...
![](../../res91.100/http-request.png)

#### HTTP响应 = 响应行+响应头+空行+消息体

![](../../res91.100/http-response.png)
...
5. XFrameOptionsMiddleware - 防范点击劫持攻击中间件
   ...
   ![](../../res91.100/click-jacking.png)

![](../../res91.100/builtin-middlewares.png)
...
1. RBAC - 基于角色的访问控制，如下图所示。
   ...
   ![](../../res91.100/rbac-basic.png)

   ![](../../res91.100/rbac-full.png)
...
![](../../res91.100/celery_architecture.png)
