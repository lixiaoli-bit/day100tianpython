...
![](../../res91.100/gitee-project-index.png)
...
5. 在线发起一次合并请求（通常称之为**Pull Request**，有的地方称为**Merge Request**），请求将自己的工作成果合并到`master`分支，合并之后可以删除该分支。
   ...
   ![](../../res91.100/gitee-pull-request.png)
...
![](../../res91.100/gitlab-new-issue.png)
...
![](../../res91.100/jenkins_new_project.png)
